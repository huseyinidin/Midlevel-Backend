public class Employee {
    ...
    // Reminder
    // Method Overloading
    public void entry(String entryOclock) {
        System.out.println(this.getName() + " " + entryOclock + " entered the university.");
    }

    // Method Overloading
    public void entry(String entryOclock, String exitOclock) {
        System.out.println(this.getName() + " " + entryOclock + " entered the university " + exitOclock + " out of university");
    }
